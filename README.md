## *Верстка на гридах* 
# **"[LatoutGrid](https://andreyvolkov88.github.io/LayoutGrid/)"**
------

## Описание проекта
Проект "LatoutGrid" представляет собой самостоятельную практику на пути освоения профессии "Web-разработчик". Он дает углубленные знания о семантике и смысле HTML-разметки, отрабатывают на практике различные возможности расположения элементов страницы и написание CSS-кода для создания анимаций. 
Учусь самостоятельно работать с макетом в графическом редакторе и знакомятся с адаптивной вёрсткой.  
"HTML и CSS — адаптивная вёрстка и работа с макетом" позволяет овладеть следующими навыками:
...
Ознакомиться с проектом вы сможете по ссылке [LatoutGrid](https://andreyvolkov88.github.io/LayoutGrid/).